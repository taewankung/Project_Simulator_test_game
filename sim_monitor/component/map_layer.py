    ...
    def __init__(self):
        ...
        self.sprite_tower_team1 = {
                                   'top': {
                                            ...
                                            'lvl2':cocos.sprite.Sprite('sim_monitor/res/sqr_red.png'),
                                            'lvl3':cocos.sprite.Sprite('sim_monitor/res/sqr_red.png')
                                          },
                                   'mid': {
                                            'lvl1':cocos.sprite.Sprite('sim_monitor/res/sqr_red.png'),
                                            'lvl2':cocos.sprite.Sprite('sim_monitor/res/sqr_red.png'),
        ...
        self.sprite_tower_team2 = {
                                   'top': {
                                            'lvl1':cocos.sprite.Sprite('sim_monitor/res/sqr_blue.png'),
                                            'lvl2':cocos.sprite.Sprite('sim_monitor/res/sqr_blue.png'),
                                            'lvl3':cocos.sprite.Sprite('sim_monitor/res/sqr_blue.png')
                                          },
                                   'mid': {
                                            'lvl1':cocos.sprite.Sprite('sim_monitor/res/sqr_blue.png'),
                                            'lvl2':cocos.sprite.Sprite('sim_monitor/res/sqr_blue.png'),
        ...
        self.sprite_base = { 'team1': cocos.sprite.Sprite('sim_monitor/res/circle_blue.png'),
                             'team2' : cocos.sprite.Sprite('sim_monitor/res/circle_red.png')
                           }
